    ...
    <footer className="bg-sky-700 text-white">
      ...
      <div className="border-t border-white/20 py-6">
        <div className="max-w-7xl mx-auto px-6 text-center text-sm text-white/80">
          © Copy rights From 2025 to {new Date().getFullYear()} Mater Dei
          School, Nyanza. All rights reserved.
          <div className="mt-2">
            <Link
              href="/privacy"
        ...
        <div className="space-y-2 text-center text-sm text-muted-foreground">
          <p className="text-xs">
            ...
            <span className="font-medium text-foreground">
              Iragha Patrick | patrickiraguha95@gmail.com
            </span>
            &nbsp; | &nbsp; Partnered with{" "}
            <span className="font-medium text-foreground">
              Gaggleniti Group campany | gaggleniti@gmail.com
            </span>
          </p>
        </div>
      </div>
